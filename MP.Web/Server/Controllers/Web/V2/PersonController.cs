...
namespace MintPlayer.Web.Server.Controllers.Web.V2
{
	...
	public class PersonController : Controller
	{
		...
		[HttpPost("page", Name = "web-v2-person-page")]
		...
		// GET: web/Person
		[HttpGet(Name = "web-v2-person-list")]
		...
		// GET: web/Person/5
		[HttpGet("{id}", Name = "web-v2-person-get", Order = 1)]
		...
		[HttpPost("favorite", Name = "web-v2-person-favorite-page")]
		[Authorize]
		...
		[HttpGet("favorite", Name = "web-v2-person-favorite")]
		[Authorize]
		...
		// POST: web/Person
		[HttpPost(Name = "web-v2-person-create")]
		[Authorize]
		...
		// PUT: web/Person/5
		[HttpPut("{id}", Name = "web-v2-person-update")]
		[Authorize]
		...
		// DELETE: web/Person/5
		[HttpDelete("{id}", Name = "web-v2-person-delete")]
		[Authorize]
