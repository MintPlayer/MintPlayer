...
namespace MintPlayer.Web.Server.Controllers.Web.V2
{
	...
	public class SongController : Controller
	{
		...
		// POST: web/Song/page
		[HttpPost("page", Name = "web-v2-song-page")]
		...
		// GET: web/Song/5
		[HttpGet("{id}", Name = "web-v2-song-get", Order = 1)]
		...
		[HttpGet("{id}/lyrics", Name = "web-v2-song-lyrics")]
		...
		[HttpPost("favorite", Name = "web-v2-song-favorite-page")]
		[Authorize]
		...
		[HttpGet("favorite", Name = "web-v2-song-favorite")]
		[Authorize]
		...
		// POST: web/Song
		[HttpPost(Name = "web-v2-song-create")]
		[Authorize]
		...
		// PUT: web/Song/5
		[HttpPut("{id}", Name = "web-v2-song-update")]
		[Authorize]
		...
		[HttpPut("{id}/timeline", Name = "web-v2-song-timeline-update")]
		[Authorize]
		...
		// DELETE: web/Song/5
		[HttpDelete("{id}", Name = "web-v2-song-delete")]
		[Authorize]
