...
namespace MintPlayer.Web.Server.Controllers.Web.V2
{
	...
	public class ArtistController : Controller
	{
		...
		[HttpPost("page", Name = "web-v2-artist-page")]
		...
		// GET: web/Artist
		[HttpGet(Name = "web-v2-artist-list")]
		...
		// GET: web/Artist/5
		[HttpGet("{id}", Name = "web-v2-artist-get", Order = 1)]
		...
		[HttpPost("favorite", Name = "web-v2-artist-favorite-page")]
		[Authorize]
		...
		[HttpGet("favorite", Name = "web-v2-artist-favorite")]
		[Authorize]
		...
		// POST: web/Artist
		[HttpPost(Name = "web-v2-artist-create")]
		[Authorize]
		...
		// PUT: web/Artist/5
		[HttpPut("{id}", Name = "web-v2-artist-update")]
		[Authorize]
		...
		// DELETE: web/Artist/5
		[HttpDelete("{id}", Name = "web-v2-artist-delete")]
		[Authorize]
