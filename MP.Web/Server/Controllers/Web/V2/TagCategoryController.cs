...
namespace MintPlayer.Web.Server.Controllers.Web.V2
{
    ...
    public class TagCategoryController : Controller
    {
        ...
        [HttpPost("page", Name = "web-v2-tagcategory-page")]
        ...
        [HttpGet(Name = "web-v2-tagcategory-list")]
        ...
        [HttpGet("{id}", Name = "web-v2-tagcategory-get", Order = 1)]
        ...
        [HttpPost(Name = "web-v2-tagcategory-create")]
        [Authorize]
        ...
        [HttpPut("{id}", Name = "web-v2-tagcategory-update")]
        [Authorize]
        ...
        [HttpDelete("{id}", Name = "web-v2-tagcategory-delete")]
        [Authorize]
