...
namespace MintPlayer.Web.Server.Controllers.Web.V1
{
    ...
    public class TagCategoryController : Controller
    {
        ...
        [HttpPost("page", Name = "web-v1-tagcategory-page")]
        ...
        [HttpGet(Name = "web-v1-tagcategory-list")]
        ...
        [HttpGet("{id}", Name = "web-v1-tagcategory-get", Order = 1)]
        ...
        [HttpPost(Name = "web-v1-tagcategory-create")]
        [Authorize]
        ...
        [HttpPut("{id}", Name = "web-v1-tagcategory-update")]
        [Authorize]
        ...
        [HttpDelete("{id}", Name = "web-v1-tagcategory-delete")]
        [Authorize]
