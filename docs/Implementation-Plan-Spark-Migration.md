...
**Exit criteria:** Full catalog manageable in admin UI; unified search/suggest works; likes work. _(Status 2026-06-08: 2.1–2.5 done — Person/Artist/Song + Medium/Tag/TagCategory CRUD, relationships, sub-queries, multi-reference tags, program-unit menus all live + verified against RavenDB; unified cross-type search + typo-tolerant suggest live (`/api/search`, RavenDB multi-map index — D1 confirmed, Elasticsearch droppable). Left: 2.6 likes / 2.7 player-type.)_
