...
**Exit criteria:** Log in, manage MediumTypes in the admin UI, deploy via Docker; i18n + PWA + SEO scaffolding in place. _(Status 2026-06-07: 1.1–1.5 done; host+SPA+auth+MediumType slice running against RavenDB, full admin CRUD walkthrough green. Left: IEmailSender, 1.6 PWA/SEO, Docker.)_
