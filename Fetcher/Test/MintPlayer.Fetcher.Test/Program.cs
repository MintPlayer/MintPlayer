...
class Program
{
	static async Task Main(string[] args)
	{
		...
		var songmeanings_song = await fetcherContainer.Fetch(url_songmeanings_song, true);

		var url_songmeanings_song1 = "https://songmeanings.com/songs/view/3530822107859455860/";
		var songmeanings_song1 = await fetcherContainer.Fetch(url_songmeanings_song1, true);

		var url_songmeanings_song3 = "https://songmeanings.com/songs/view/3530822107858740205/";
		var songmeanings_song3 = await fetcherContainer.Fetch(url_songmeanings_song3, true);
		#endregion

		#region Artist
		var url_songmeanings_artist1 = "https://songmeanings.com/artist/view/songs/137438984319/";
		var songmeanings_artist1 = await fetcherContainer.Fetch(url_songmeanings_artist1, true);
		#endregion
		...
		var musixmatch_song = await fetcherContainer.Fetch(url_musixmatch_song, true);
		#endregion

		#region Artist - OK
		var url_musixmatch_artist = "https://www.musixmatch.com/artist/The-Weeknd";
		var musixmatch_artist = await fetcherContainer.Fetch(url_musixmatch_artist, true);
		#endregion

		#region Album - OK
		var url_musixmatch_album = "https://www.musixmatch.com/album/The-Weeknd/The-Weeknd-In-Japan";
		var musixmatch_album = await fetcherContainer.Fetch(url_musixmatch_album, true);
		#endregion
		...
		var lyricscom_song = await fetcherContainer.Fetch(url_lyricscom_song, true);
		#endregion

		#region Artist - OK
		var url_lyricscom_artist = "https://www.lyrics.com/artist/Daft-Punk/168791";
		var lyricscom_artist = await fetcherContainer.Fetch(url_lyricscom_artist, true);
		#endregion

		#region Album - OK
		var url_lyricscom_album_1 = "https://www.lyrics.com/album/3810277/100-Greatest-Classic-Rock-Songs";
		var lyricscom_album_1 = await fetcherContainer.Fetch(url_lyricscom_album_1, true);
		#endregion

		#region Album - OK
		var url_lyricscom_album_2 = "https://www.lyrics.com/album/2860319/Life-is-But-a-Dream";
		var lyricscom_album_2 = await fetcherContainer.Fetch(url_lyricscom_album_2, true);
		#endregion
		...
		var songtekstennet_song = await fetcherContainer.Fetch(url_songtekstennet_song, true);
		#endregion

		#region Album - OK
		var url_songtekstennet_album = "https://songteksten.net/albums/album/235/103/red-hot-chili-peppers/californication.html";
		var songtekstennet_album = await fetcherContainer.Fetch(url_songtekstennet_album, true);
		#endregion
		...
		var songtekstennet_artist = await fetcherContainer.Fetch(url_songtekstennet_artist, true);
		#endregion
		...
		var azlyrics_song = await fetcherContainer.Fetch(url_azlyrics_song, true);
		#endregion

		#region Artist
		const string url_azlyrics_artist = "https://www.azlyrics.com/d/daftpunk.html";
		var azlyrics_artist = await fetcherContainer.Fetch(url_azlyrics_artist, true);
		#endregion
		...
		var songlyrics_song = await fetcherContainer.Fetch(url_songlyrics_song, true);
		#endregion

		#region Artist
		const string url_songlyrics_artist = "http://www.songlyrics.com/red-hot-chilli-peppers-lyrics/";
		var songlyrics_artist = await fetcherContainer.Fetch(url_songlyrics_artist, true);
		#endregion

		#region Album
		const string url_songlyrics_album = "http://www.songlyrics.com/red-hot-chilli-peppers/live-to-air/";
		var songlyrics_album = await fetcherContainer.Fetch(url_songlyrics_album, true);
		#endregion
		...
		var lololyrics_song = await fetcherContainer.Fetch(url_lololyrics_song, true);
		#endregion

		#region Artist
		var url_lololyrics_artist = "https://www.lololyrics.com/artist/Daft+Punk";
		//var url_lololyrics_song = "https://www.lololyrics.com/lyrics/32008.html";
		var lololyrics_artist = await fetcherContainer.Fetch(url_lololyrics_artist, true);
		#endregion
