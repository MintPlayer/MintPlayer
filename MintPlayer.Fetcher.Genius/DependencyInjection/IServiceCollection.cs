    ...
    public static class IServiceCollectionExtensions
    {
        public static IServiceCollection AddGeniusFetcher(this IServiceCollection services)
        {
            return services
                ...
                .AddSingleton<Genius.Parsers.V1.IV1Parser, Genius.Parsers.V1.V1Parser>()
                .AddSingleton<Genius.Parsers.V2.IV2Parser, Genius.Parsers.V2.V2Parser>()
                .AddSingleton<Genius.Parsers.V3.IV3Parser, Genius.Parsers.V3.V3Parser>()
                ...
                .AddSingleton<Genius.Helpers.ILyricsTrimmer, Genius.Helpers.LyricsTrimmer>()
