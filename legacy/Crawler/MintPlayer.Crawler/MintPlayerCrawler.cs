    ...
    public class MintPlayerCrawler
    {
        ...
        public async Task Start()
        {
            ...
            while (true)
            {
                ...
                var current_jobs = crawlJobs.Where(j => {
                    ...
                    return j.Status == Enums.CrawlStatus.Pending;
                }).Take(20).ToArray();
                ...
                // Invoke the event
                OnSubjectsDiscovered(new SubjectsDiscoveredEventArgs(crawled_subjects_filtered));
        ...
        private async Task<Fetcher.Abstractions.Dtos.Subject> RunJob(CrawlJob<Fetcher.Abstractions.Dtos.Subject> job)
        {
            try
            {
                ...
                job.Status = Enums.CrawlStatus.Success;
            ...
            catch (Exception ex)
            {
                ...
                Console.ResetColor();
                job.Status = Enums.CrawlStatus.Error;
                return null;
            }
        }
    }
