namespace MintPlayer.Data.Mappers
{
    ...
    {
        Dtos.Jobs.ElasticSearchIndexJob Entity2Dto(Entities.Jobs.ElasticSearchIndexJob job, bool include_relations, bool include_invisible_media);
    ...
    internal class ElasticSearchIndexJobMapper : IElasticSearchIndexJobMapper
    {
        ...
        public Dtos.Jobs.ElasticSearchIndexJob Entity2Dto(Entities.Jobs.ElasticSearchIndexJob job, bool include_relations, bool include_invisible_media)
        {
            ...
            return new Dtos.Jobs.ElasticSearchIndexJob
            {
                ...
                Subject = subjectMapper.Entity2Dto(job.Subject, include_relations, include_invisible_media),
