...
namespace MintPlayer.Data
{
    ...
    {
        // cd MintPlayer.Web
        // dotnet ef migrations add AddIdentity --project ..\MintPlayer.Data
        // dotnet ef database update --project ..\MintPlayer.Data

        // To generate production migrations
        // dotnet ef migrations script --output "MigrationScripts\AddIdentity.sql" --context MintPlayerContext --project ..\MintPlayer.Data
        // dotnet ef migrations script AddIdentity --output "MigrationScripts\AddCoreEntities.sql" --context MintPlayerContext --project ..\MintPlayer.Data
        //
        // dotnet ef migrations add AddLikes --project ..\MintPlayer.Data
        // dotnet ef migrations script AddCoreEntities --output "MigrationScripts\AddLikes.sql" --context MintPlayerContext --project ..\MintPlayer.Data

        // cd web
        // dotnet ef migrations script AddTimestamps --output "MigrationScripts\AddMediumTypeVisible.sql" --context MintPlayerContext --project ..\MP.Data
